...
{
    [AddComponentMenu("UI/MScroll Rect")]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class MScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        //--------------MScroll Begin-------------------------//

        private Vector2 m_tmpDragPoint = Vector2.zero;
        ...
        [Serializable]
        public class MScrollRectEvent : UnityEvent<Vector2> { }
        ...
        [SerializeField]
        private MScrollRectEvent m_OnValueChanged = new MScrollRectEvent();
        public MScrollRectEvent onValueChanged { get { return m_OnValueChanged; } set { m_OnValueChanged = value; } }
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            m_tmpDragPoint = new Vector2(localCursor.x, localCursor.y);
        ...
        {
            m_PointerStartLocalCursor = m_tmpDragPoint;
            m_ContentStartPosition = m_Content.anchoredPosition;
        }
