...
////// Lighting:
                ...
                float3 finalColor = ((_BackFace + ( ((1.0 - isFrontFace) - node_6202) * (node_9143 - _BackFace) ) / (node_9143 - node_6202))*(_Diffuse_var.rgb*_Diffuse_var.a*_Color.rgb));
