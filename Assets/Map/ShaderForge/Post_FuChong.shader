...
////// Emissive:
                ...
                float node_352_ang = node_9398.g;
                ...
                float node_6244_ang = node_9398.g;
                ...
                return fixed4(finalColor,(pow((distance(i.uv0,float2(0.5,0.5))*2.0+0.0),exp(_node_1697))*_node_1324));
            }
            ENDCG
        }
    }
