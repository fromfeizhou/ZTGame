...
////// Emissive:
                ...
                float3 emissive = (saturate((sceneZ-partZ))*((_MainTex_var.rgb*i.vertexColor.rgb*_TintColor.rgb*2.0*i.vertexColor.a)*_Mask_var.a)*i.vertexColor.a*(_Noise1_var.rgb*_Noise2_var.rgb));
