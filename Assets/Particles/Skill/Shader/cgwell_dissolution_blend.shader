    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_6644 = (_ColorAlpha.a*(_DiffuseTexture_var.a*(node_5746+node_1274)));
                clip(node_6644 - 0.5);
////// Lighting:
////// Emissive:
