...
{
    [CustomEditor(typeof(MScrollRect), true)]
    [CanEditMultipleObjects]
    public class MScrollRectEditor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)MScrollRect.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((MScrollRect)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((MScrollRect.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == MScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((MScrollRect.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == MScrollRect.ScrollbarVisibility.AutoHideAndExpandViewport
