...
{
    public static bool _isAutoGroup;
    [MenuItem("MyTool/Sprite/SpriteAsset")]
    ...
    private static Vector2[] GetSpriteUV(Vector2 texSize,Rect _sprRect)
    {
        ...
        uv[0] = new Vector2(_sprRect.x / texSize.x, (_sprRect.y+_sprRect.height) / texSize.y);//左上
        uv[1] = new Vector2((_sprRect.x + _sprRect.width) / texSize.x, (_sprRect.y +_sprRect.height) / texSize.y);//右上
        uv[2] = new Vector2((_sprRect.x + _sprRect.width) / texSize.x, _sprRect.y / texSize.y);//右下
        uv[3] = new Vector2(_sprRect.x / texSize.x, _sprRect.y / texSize.y);//左下
        return uv;
    }
