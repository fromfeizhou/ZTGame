...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaMainSceneWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(LuaMainScene);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaMainScene __cl_gen_ret = new LuaMainScene();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to LuaMainScene constructor!");
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
		    try {
                ...
                LuaMainScene __cl_gen_to_be_invoked = (LuaMainScene)translator.FastGetCSObj(L, 1);
