    ...
    public class XLua_Gen_Initer_Register__
	{
	    static XLua_Gen_Initer_Register__()
        {
		    XLua.LuaEnv.AddIniter((luaenv, translator) => {
				...
				translator.DelayWrapLoader(typeof(Widget), WidgetWrap.__Register);
				...
				translator.AddInterfaceBridgeCreator(typeof(ZTXLuaEnv.ItfSkillTab), ZTXLuaEnvItfSkillTabBridge.__Create);
